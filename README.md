...
5. **Automated Generation**: These SBOMs are generated using [waybill](https://github.com/kusari-oss/waybill) with deps.dev enrichment for license and dependency resolution. The generation process runs weekly and supports **all ecosystems** that waybill can detect (Go, Rust, npm, Python, Java/Maven, Ruby, and more).
...
- Generates SPDX 2.3-compliant SBOM files using [waybill](https://github.com/kusari-oss/waybill) (v0.1.0-alpha.69)
...
| `WAYBILL_VERSION` | waybill release version to use (default: v0.1.0-alpha.69) |
...
- Creator: `Tool: waybill-0.1.0-alpha.69`
...
# Or install manually
curl -sL https://github.com/kusari-oss/waybill/releases/download/v0.1.0-alpha.69/waybill-v0.1.0-alpha.69-x86_64-unknown-linux-gnu.tar.gz | tar xz
sudo cp waybill-v0.1.0-alpha.69-x86_64-unknown-linux-gnu/waybill /usr/local/bin/
```
